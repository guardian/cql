  ...
  class CqlInput extends HTMLElement {
    ...
    connectedCallback() {
      ...
      shadow.innerHTML = `
        ...
        <div id="${cqlTypeaheadId}" className="Cql__TypeaheadPopoverContainer" data-testid="${typeaheadTestId}" popover="manual"></div>
        <div id="${cqlErrorId}" className="Cql__ErrorPopover" data-testid="${errorTestId}" popover="manual"></div>
      `;
