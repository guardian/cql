...
const Discourse: Tool = {
  name: "Discourse",
  description:
    "An internal discussion board for editorial. Self hosted instance of discourse.org",
  team: "investigations",
  keywords: ["investigations"],
  primaryLink: prodLink("https://discourse.gutools.co.uk"),
  awsAccount: "investigations",
  links: [riffRaffLink("investigations::discourse")],
};
...
const All: Array<Tool> = [Lurch, Giant, Discourse, TranscriptionService];
