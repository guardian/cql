...
const Pubflow: Tool = {
  name: "Pubflow",
  description:
    "Track the progress of content through the production workflow and into CAPI.",
  team: "capi",
...
const KongKeyMon: Tool = {
  ...
  primaryLink: prodLink(
    "https://kongkeymon.capi.gutools.co.uk/_plugin/kibana/app/dashboards",
  ),
  links: [
    githubLink("kongkeymon"),
    {
      description: "CODE",
      url: new URL(
        "https://kongkeymon.capi.code.dev-gutools.co.uk/_plugin/kibana/app/dashboards/",
      ),
    },
  ],
};
