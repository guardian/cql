...
const HrSystem: Tool = {
  name: "HR System",
  description:
    'Performing HR related tasks (login via "company single sign-on")',
  team: "misc",
...
const AdminGuide: Tool = {
  ...
  team: "misc",
  keywords: ["admin"],
  primaryLink: prodLink(
    "https://docs.google.com/document/d/1ErsZUEL0ELiGUYXHbEWlm0mLGY7lZoAnzF4IXWqnPG0/edit",
  ),
};
...
const IncidentResponse: Tool = {
  ...
  primaryLink: prodLink(
    "https://docs.google.com/document/d/1HQxblYg0nh48UJlmh_qlWHfXB5EYJRStcKvoWAqyM_Y",
  ),
};
...
const AWSBudgets: Tool = {
  ...
  links: [githubLink("aws-budgets")],
};

const ElasticsearchNodeRotation: Tool = {
  name: "Elasticsearch Node Rotation",
  description:
    "Safely rotate in a new Elasticsearch node.  See links on a given execution step to logs for that step. Used by various teams (see riff-raff.yaml deployments)",
  team: "misc",
...
const ImageUrlSigner: Tool = {
  ...
  primaryLink: prodLink(
    "http://image-url-signer.s3-website-eu-west-1.amazonaws.com/",
  ),
  links: [githubLink("image-url-signer-lambda")],
};

const Snyk: Tool = {
  name: "Snyk",
  description:
    "Snyk. Use your @guardian.co.uk address to login. You also need to be a member of the engineering@theguardian.com group (ask your manager to add you).",
  team: "misc",
...
const CvRedact: Tool = {
  name: "CV Redact",
  description:
    "Tool for redacting CVs in pdf format for name-blind recruitment",
  team: "misc",
...
const TheKingsPath: Tool = {
  name: "The Kings Path",
  description: "Helps you navigate the office at Kings Place",
  team: "misc",
  keywords: [
    "kings place",
    "office",
