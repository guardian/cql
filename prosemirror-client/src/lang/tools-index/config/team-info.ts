...
const EditorialToolsInfo: TeamInfo = {
  ...
  links: [{
    ...
    url: new URL('https://docs.google.com/forms/d/e/1FAIpQLSeZje55T3OnErlTI_8iGuyZERjDy2Pybh8fdPmbnjy1PNFDAw/viewform')
  }, {
    description: 'View health rota',
    url: new URL('https://docs.google.com/spreadsheets/d/1LVKJArZDJsq5R17zGCfto1b_BIgVcJF8MELR7bDPYpM/edit?usp=sharing')
  }, {
    description: 'Logs',
    url: new URL('https://logs.gutools.co.uk/goto/e3f2ce37ecf92aad24f3b84e41d0e27b')
  }]
}
...
const DevxTeamInfo: TeamInfo = {
  ...
  links: [{
    ...
    url: new URL('https://github.com/orgs/guardian/teams/deploy-infrastructure/repositories')
  }, {
    description: 'DevX introduction presentation',
    url: new URL('https://docs.google.com/presentation/d/11XrwvTSjqAshKFQs-BeZj6_tTMAbEZhz7GbDHLyGmIU/edit#slide=id.g4524256496_0_0')
  }]
}
...
const OphanTeamInfo: TeamInfo = {
  ...
  links: [{
    ...
    description: 'Logs',
    url: new URL('https://es6-monitor.ophan.co.uk/app/monitoring#/overview?_g=(cluster_uuid:X5hBehuBQweta9Til7E9SQ)')
  }, {
